...
exports.SupplierServiceFake = SupplierServiceFake;
class SupplierResolverFake {
    async supplierTestQuery() { }
    async supplierTestMutation() { }
    async build() { }
    async rebuild() { }
    async fetchById() { }
}
exports.SupplierResolverFake = SupplierResolverFake;
let KasabeTestFakeModule = class KasabeTestFakeModule {
};
KasabeTestFakeModule = __decorate([
    common_1.Module({
        imports: [
        ...
        providers: [
            ...
            {
                provide: supplier_resolver_1.SupplierResolver,
                useClass: SupplierResolverFake,
            },
...
exports.KasabeTestFakeModule = KasabeTestFakeModule;
//# sourceMappingURL=kasabe_test_fake.module.js.map