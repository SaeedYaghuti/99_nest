...
__decorate([
    ...
    __metadata("design:returntype", Promise)
], MerchantResolver.prototype, "merchantBuild", null);
__decorate([
    graphql_1.Mutation(type => merchant_entity_1.Merchant),
    __param(0, graphql_1.Args('merchant')),
    __metadata("design:type", Function),
    ...
    __metadata("design:returntype", Promise)
], MerchantResolver.prototype, "merchantRebuild", null);
__decorate([
    ...
    __metadata("design:returntype", Promise)
], MerchantResolver.prototype, "merchantFetchById", null);
