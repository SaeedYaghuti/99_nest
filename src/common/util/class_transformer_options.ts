// https://github.com/typestack/class-transformer/blob/master/src/ClassTransformOptions.ts
...
export const transformOptionsMsgToRoom: ClassTransformOptions = {
    // groups: ['Room'],
    // excludeExtraneousValues: true,

}

export const transformOptionsMsgToClient: ClassTransformOptions = {
    // groups: ['Client'],
    // excludeExtraneousValues: true,
