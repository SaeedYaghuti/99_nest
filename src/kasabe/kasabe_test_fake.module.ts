...
export class SupplierServiceFake {
    public async testQuery(): Promise<void> {}
    public async build(): Promise<void> {}
    public async rebuild(): Promise<void> {}
    public async fetchById(): Promise<void> {}
}
export class SupplierResolverFake {
    public async supplierTestQuery(): Promise<void> {}
    public async supplierTestMutation(): Promise<void> {}
    public async build(): Promise<void> {}
    public async rebuild(): Promise<void> {}
    public async fetchById(): Promise<void> {}
}
...
export class KasabeTestFakeModule {}
